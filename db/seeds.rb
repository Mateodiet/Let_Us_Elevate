...
UserChallenge.create!(challenge: challenge, user: victor,status: false)
UserChallenge.create!(challenge: challenge_2, user: victor,status: true)
UserChallenge.create!(challenge: challenge_3, user: victor,status: false)
p "#{UserChallenge.count} user challenge created"

# UserDesign.create!(design:, user:,image:, description:)
