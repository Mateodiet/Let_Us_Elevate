...
challenge = Challenge.create!(title: "Tes prises de décision", description: "Prendre des décisions en analysant et en prenant du temps au lieu de suivre ton intuition sur le moment", design: vic_design )
challenge_2 = Challenge.create!(title: "Ta capacité d'observer", description: "Observer ses propres réactions lorsque les autres ne te comprenent pas, ne t'acceptent pas ou ne suivent pas ton mouvements", design: vic_design )
challenge_3 = Challenge.create!(title: "L'impact de ton aura", description: "Faire une liste de spersonnes pouvant être impactées par tes actions et tes décisions", design: vic_design )
challenge_4 = Challenge.create!(title: "Fuir ton mode spectateur", description: "Ne pas initier et attendre que les autres fassent le premier pas ou t'invitent dans leurs oportunités", design: vic_design )
challenge_5 = Challenge.create!(title: "Réprimer ta colère", description: "Ne pas avoir peur de ta colère et tenter de la faire taire sans l'exprimer", design: vic_design )
challenge_6 = Challenge.create!(title: "Exposer tes projets", description: "Oublier ou refuser d'informer et dissimuler tes projets ou tes intentions par peur d'être controlé.e ou empêché.e", design: vic_design )
challenge_7 = Challenge.create!(title: "Éclaircir tes intentions", description: "Clarifier ses intentions avant de se lancer", design: vic_design )
